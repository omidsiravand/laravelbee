        ...
        <div class="col-6 offset-3">
            ...
            <form action="{{route('menu.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title1" id="title1" class="form-control border-bottom border-warning border-2 border-top text-white" style="border: none; background-color: rgba(0, 0, 0, 0.253);">
                    @error('title1')
                ...
                <div class="form-group">
                    <div class="octagon"></div>
                    <label for="p">p</label>
                    <input type="text" name="p" id="p" class="form-control border-bottom border-warning border-2 border-top text-white" style="border: none; background-color: rgba(0, 0, 0, 0.253);">
                    @error('p')
                        <p class="text-danger">{{$message}}</p>
                    @enderror
                </div>
